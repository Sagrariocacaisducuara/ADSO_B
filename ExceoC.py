#esto es una funcion definimos y le ponemos un nombre ala funcion que tendra dos parametro
def try_syntax(numerator, denominator):
#el try es un bloque de codigo al momento de hacer una comprobacion de errores
    try:
        print(f'In the try block: {numerator}/{denominator}')
#en esta linea nos muestra que se crea una variable dentro del print la cual es la que se va a revisar, dentor de esa variable 
...
#esta lina lo que hace es  devolver la divicion del resultado
        return result

    finally:
#n esta linea va imprimir un argumento y lo muestra por panatalla
        print('Exiting')
